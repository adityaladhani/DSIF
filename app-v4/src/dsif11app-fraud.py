...
def get_feature_importance():
    ...
    features = ['transaction_amount', 'customer_age', 'customer_balance', 'transaction_time', 'transaction_amount_to_balance_ratio']
...
def get_feature_importance():
    ...
    feature_names = ['transaction_amount', 'customer_age', 'customer_balance', 'transaction_time', 'transaction_amount_to_balance_ratio']
